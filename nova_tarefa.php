            ...
            <div class="form-card card">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="input" type="text" name="titulo" placeholder="Ex: Atualizar Website" required>
                    </div>

                    <div class="form-group">
                        <label>Descrição</label>
                        <textarea class="textarea" name="descricao" rows="5" placeholder="Escreve uma breve descrição da tarefa"></textarea>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select" name="status">
                                <option value="pendente">Por Fazer</option>
                        ...
                        <div class="form-group">
                            ...
                            <input class="input" type="date" name="data_limite">
                        </div>
